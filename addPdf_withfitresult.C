...
void addPdf_withfitresult()
{
  ...
  RooRealVar nsig("nsig","signal events",20000,0,80000);
  RooRealVar nbkg("nbkg","signal background events",10000,0,20000);

  RooAddPdf  model("model","Gauss+shape",RooArgList(gauss,shape),RooArgList(nsig,nbkg)) ;
